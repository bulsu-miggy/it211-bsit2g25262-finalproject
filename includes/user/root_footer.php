<?php
$lacesFooterYear = isset($lacesFooterYear) ? (string) $lacesFooterYear : '2026';
$lacesFooterNewsletterText = isset($lacesFooterNewsletterText)
    ? (string) $lacesFooterNewsletterText
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <p class="text-white-50 small"><?php echo htmlspecialchars($lacesFooterNewsletterText, ENT_QUOTES, 'UTF-8'); ?></p>
        ...
        <div class="row">
            <div class="col text-center text-white-50 small py-3">
                &copy; <?php echo htmlspecialchars($lacesFooterYear, ENT_QUOTES, 'UTF-8'); ?> Laces. All rights reserved.
            </div>
        </div>
    </div>
</footer>
