    ...
    <div class="container py-5 mt-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-5 text-center position-relative">
               <h1 class="display-1 fw-bold text-uppercase mb-n5 position-relative z-1 text-nowrap" style="font-weight: 900; opacity: 0.8;">DALBIT</h1>
                <img src="../products/images/oneus.png" alt="ONEUS Lightstick" class="img-fluid position-relative z-2" style="filter: drop-shadow(0 15px 15px rgba(0,0,0,0.1));">
            </div>

            <div class="col-md-7 ps-md-5">
                <h2 class="display-3 fw-bold mb-4">ONEUS Official Lightstick</h2>
                
                <p class="fs-5 mb-4 text-dark">Size: <span class="fw-bold">239 x 100 x 50 (mm)</span></p>
                
                <div class="mb-4">
                    <h5 class="fw-bold">📦 Inclusions</h5>
                    <ul class="list-unstyled ms-3 fs-5">
                        <li class="mb-1">• 1 x ONEUS Bong Lightstick & Box</li>
                ...
                <div class="row align-items-center">
                    <div class="col-6">
                        <p class="h1 display-2 fw-bold mb-0">₱2,000</p>
                        <small class="text-uppercase ms-2 text-secondary fw-bold d-inline-block" style="letter-spacing: 2px; white-space: nowrap;">price</small>
                    </div>
            <form action="../Cart/cart.php" method="POST" class="col-6 text-end">
                <input type="hidden" name="product_id" value="oneus_lightstick">
                <input type="hidden" name="product_name" value="ONEUS Dalbit">
                <input type="hidden" name="product_price" value="2000">
                <input type="hidden" name="product_image" value="../images/oneus.png">
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-md-10 text-center">
                <h2 class="text-start fw-bold mb-4 display-6" style="color: #4a90e2;">Inclusions:</h2>
                 <img src="../../images/oneusInclu.png" class="img-fluid w-75" alt="inclusions">
            </div>
        </div>
                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td class="bg-light p-3 px-4">ONEUS Official Lightstick</td>
                        </tr>
                        <tr>
