        ...
        <div class="d-flex">
            ...
            <nav class="d-flex flex-column flex-shrink-0 p-0 text-white shadow" style="width: 280px; height: 100vh; background-color: #1a237e; position: sticky; top: 0;">
                ...
                <ul class="nav nav-pills flex-column mb-auto p-3 pt-4">
                    ...
                    <li class="nav-item mb-2">
                        <a href="products.php" class="nav-link active bg-white text-dark py-3 shadow-sm rounded-3">
            ...
            <div class="flex-grow-1">
                ...
                <div class="bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center sticky-top shadow-sm">
                    <h5 class="mb-0 fw-bold text-dark border-start border-4 border-primary ps-3" style="border-color: #1a237e !important;">Products</h5>
                    <div class="d-flex align-items-center gap-4">
                        <div class="input-group input-group-sm d-none d-md-flex" style="width: 250px;">
                            <span class="input-group-text bg-light border-0"><i class="bi bi-search"></i></span>
                            <input type="text" class="form-control bg-light border-0" placeholder="Search product...">
                        </div>
                            ...
                            <div class="row g-2 align-items-center">
                                <div class="col-md-9">
                                    <div class="input-group border rounded-3 overflow-hidden">
                                        ...
                                        <input type="text" class="form-control border-0 ps-0" placeholder="Search products...">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-1">
                                    <div class="btn-group w-100 shadow-sm rounded-3">
                                        <button class="btn btn-outline-secondary active"><i class="bi bi-list-ul"></i></button>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody class="bg-white">
                                    <?php
                                    $products = [
                                        ['name' => 'TXT Moa Bong', 'cat' => 'Boy Group', 'price' => '₱2,000.00', 'stock' => 45, 'status' => 'Active', 'color' => 'success'],
                                        ['name' => 'Twice Candy Bong', 'cat' => 'Girl group', 'price' => '₱2,000.00', 'stock' => 23, 'status' => 'Active', 'color' => 'success'],
                                        ['name' => 'BTS Army Bomb', 'cat' => 'Boy group', 'price' => '₱2,000.00', 'stock' => 120, 'status' => 'Active', 'color' => 'success'],
                                    ];
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td class="text-muted small"><?php echo $p['cat']; ?></td>
                                        <td class="fw-bold text-dark"><?php echo $p['price']; ?></td>
                                        <td class="text-muted"><?php echo $p['stock']; ?></td>
                                        <td>
                                            <span class="badge rounded-pill px-3 py-2 fw-normal bg-<?php echo $p['color']; ?>-subtle text-<?php echo $p['color']; ?> border border-<?php echo $p['color']; ?>-subtle">
                                                <?php echo $p['status']; ?>
                                            </span>
                                        </td>
