...
$beverages = array_filter($allProducts, function($p) {
    if (!empty($p['category_slug'])) {
        return strtolower($p['category_slug']) === 'beverages';
    }
    return !empty($p['category_name']) && strtolower($p['category_name']) === 'beverages';
});


if (count($beverages) < 10) {
    $sampleBeverages = [
        ['id' => 11001, 'name' => 'Calamansi Juice', 'category_name' => 'Beverages', 'price' => 80, 'description' => 'Freshly squeezed calamansi juice - sweet, sour, and refreshing.', 'image_emoji' => '🍊', 'is_active' => 1],
        ['id' => 11002, 'name' => 'Buko Juice', 'category_name' => 'Beverages', 'price' => 70, 'description' => 'Fresh coconut water straight from young coconuts - naturally sweet.', 'image_emoji' => '🥥', 'is_active' => 1],
        ['id' => 11003, 'name' => 'Sago\'t Gulaman', 'category_name' => 'Beverages', 'price' => 65, 'description' => 'Brown sugar drink with tapioca pearls and jelly - sweet and chewy.', 'image_emoji' => '🧋', 'is_active' => 1],
        ['id' => 11004, 'name' => 'Halo-Halo Shake', 'category_name' => 'Beverages', 'price' => 120, 'description' => 'Famous Filipino dessert turned into a shake - creamy and fruity.', 'image_emoji' => '🥤', 'is_active' => 1],
        ['id' => 11005, 'name' => 'Mango Shake', 'category_name' => 'Beverages', 'price' => 95, 'description' => 'Fresh Philippine mango shake - sweet and creamy.', 'image_emoji' => '🥭', 'is_active' => 1],
        ['id' => 11006, 'name' => 'Tsokolate Eh', 'category_name' => 'Beverages', 'price' => 85, 'description' => 'Thick Filipino hot chocolate made with tablea - rich and creamy.', 'image_emoji' => '☕', 'is_active' => 1],
        ['id' => 11007, 'name' => 'Kapeng Barako', 'category_name' => 'Beverages', 'price' => 80, 'description' => 'Strong Filipino coffee - bold and aromatic.', 'image_emoji' => '☕', 'is_active' => 1],
        ['id' => 11008, 'name' => 'Buko Pandan Drink', 'category_name' => 'Beverages', 'price' => 85, 'description' => 'Coconut water with pandan flavor - fragrant and sweet.', 'image_emoji' => '🌴', 'is_active' => 1],
        ['id' => 11009, 'name' => 'Four Seasons Juice', 'category_name' => 'Beverages', 'price' => 95, 'description' => 'Mix of apple, orange, pineapple, and calamansi - sweet and sour.', 'image_emoji' => '🍎', 'is_active' => 1],
        ['id' => 11010, 'name' => 'Avocado Shake', 'category_name' => 'Beverages', 'price' => 100, 'description' => 'Creamy avocado shake - rich and satisfying.', 'image_emoji' => '🥑', 'is_active' => 1]
    ];
    $beverages = array_merge($beverages, $sampleBeverages);
}
...
<head>
    ...
    <title>Beverages - Lasa Filipina</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        /* Same styles as dishes.php */
...
<body>
    ...
    <div class="text-left mt-30 p-5">
        ...
        <p class="lead">Traditional Filipino drinks to quench your thirst</p>
    </div>

    <div class="product-grid">
        <?php 
        $displayed = 0;
        foreach ($beverages as $product): 
            if ($displayed >= 10) break;
            $displayed++;
            $productId = $product['id'];
            $placeholderImage = "../images/beverages/" . strtolower(str_replace([' ', '-', "'"], '_', $product['name'])) . ".jpg";
        ?>
        <div class="card custom-card h-100" data-product-id="<?php echo htmlspecialchars($productId); ?>" onclick="onCardClick(event, '<?php echo addslashes($productId); ?>')" style="cursor: pointer;">
            <div class="card-img-top">
                <img src="<?php echo $placeholderImage; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" onerror="this.src='https://placehold.co/400x250/e8f0f8/5a9bc6?text=Drink'">
            </div>
