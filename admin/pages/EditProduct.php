    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl text-gray-800 mb-2">Edit Product</h1>
      ...
      <div className="border-2 border-gray-300 bg-white rounded p-8">
        <div className="space-y-6 max-w-4xl">
          ...
          <div>
            ...
            <textarea 
              rows={4}
              defaultValue="Premium wireless headphones with noise cancellation"
          ...
          <div>
            ...
            <input 
              type="text" 
              defaultValue="wireless, audio, premium"
