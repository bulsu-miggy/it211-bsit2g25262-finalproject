...
export function EditCategoryPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    metaDescription: 'Browse our collection of electronic devices including smartphones, laptops, and more.',
    isActive: true,
    isFeatured: true
  });
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl text-gray-800 mb-2">Edit Category</h1>
            <p className="text-gray-600">Update category details</p>
          </div>
        </div>
        <button 
          onClick={handleDelete}
          className="border-2 border-red-300 bg-white text-red-600 px-6 py-2.5 rounded hover:bg-red-50 transition-colors flex items-center gap-2"
        >
