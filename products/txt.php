    ...
    <div class="container py-5 mt-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-5 text-center position-relative">
                <h1 class="display-1 fw-black text-uppercase mb-n5 position-relative z-1" style="font-weight: 900; opacity: 0.8;">MOA Bong</h1>
                <img src="../products/images/txt.png" alt="TXT Lightstick" class="img-fluid position-relative z-2" style="filter: drop-shadow(0 15px 15px rgba(0,0,0,0.1));">
            </div>

            <div class="col-md-7 ps-md-5">
                <h2 class="display-3 fw-bold mb-4">TXT Official Lightstick</h2>
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled ms-3 fs-5">
                        <li class="mb-1">• 1 x TXT MOA Bong Lightstick & Box</li>
            ...
            <form action="../Cart/cart.php" method="POST" class="col-6 text-end">
                <input type="hidden" name="product_id" value="txt_lightstick">
                <input type="hidden" name="product_name" value="TXT Official Lightstick">
                <input type="hidden" name="product_price" value="2999">
                <input type="hidden" name="product_image" value="../images/txt.png">
            ...
            <div class="row mb-5 justify-content-center">
                <div class="col-md-10 text-center">
                    ...
                    <img src="../images/txtinc.png" class="img-fluid w-75" alt="inclusions">
                </div>
            </div>
                ...
                <table class="table table-bordered mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td class="bg-light p-3 px-4">TXT Official Lightstick</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="bg-light p-3 px-4">
                                <ol class="ps-3 mb-0 small">
                                    ...
                                    <li>Use standard alkaline AAA batteries that were not used before. Avoid using manganese or used batteries.</li>
                                </ol>
                            </td>
                        </tr>
                    </tbody>
